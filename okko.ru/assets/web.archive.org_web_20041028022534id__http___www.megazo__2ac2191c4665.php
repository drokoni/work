...
<html>
<head>
	<title>Цифровые фотоаппараты - цифровая техника MEGAZOOM.RU</title>
	
	<link rel=STYLESHEET href="style.css" type="text/css">
<meta name="Title" content="Цифровые фотоаппараты - цифровая техника MEGAZOOM.RU">
		<meta name="Description" content="Цифровые фотоаппараты, ">
		<meta name="KeyWords" content="Цифровые фотоаппараты, ">
...
<tr><td>&nbsp;&nbsp;<b><font class=light><nobr>> Цифровые фотоаппараты</nobr></font></b>
</td></tr>
...
<a href="index.php" class="cat">Главная</a> : <a class="cat" href="index.php?categoryID=2">Фото / Видео</a> : Цифровые фотоаппараты:<br></b></font></td></tr></table><p></p>
</p><p></p>
<center>
...
<td width=1% align=center valign=top rowspan=2> <!-- product picture -->
	<a href="index.php?productID=6"><img src="products_pictures/genius_g-shot_p433s.gif" border=0 width="60" height="51" alt="подробнее... ...">
...
<td>
	...
	<a class=cat href="index.php?productID=6">Цифровой фотоаппарат Genius G-Shot P433</a></td>
...
<td align=right valign=top> <!-- add to cart link -->
	...
	<a href="javascript:open_window('cart.php?add=6',400,300);"><img src="images/cart_small.gif" border=0 alt="добавить в корзину"></a>
</td>
</tr>
...
<td colspan=2>
	...
	<b>Наша цена: <font  color=red>USD 193</font></b>
...
<!-- description -->
	...
	<td width=99% colspan=2><p>Genius G-Shot P433     - цифровая фотокамера с разрешением ПЗС-матрицы 4 млн. пикселей. Максимальное разрешение фотокадров 2304 х 1728.
 </td>
...
<tr>
<td width=1% align=center valign=top rowspan=2> <!-- product picture -->
	<a href="index.php?productID=7"><img src="products_pictures/olympus_c-460z_del_solssss.gif" border=0 width="60" height="39" alt="подробнее... ...">
<font class=small><nobr>подробнее...</nobr></font></a>
...
<td>
	...
	<a class=cat href="index.php?productID=7">Цифровой фотоаппарат Olympus C-460Z del Sol</a></td>
...
<td align=right valign=top> <!-- add to cart link -->
	...
	<a href="javascript:open_window('cart.php?add=7',400,300);"><img src="images/cart_small.gif" border=0 alt="добавить в корзину"></a>
</td>
</tr>
...
<td colspan=2>
	...
	<b>Наша цена: <font  color=red>USD 269</font></b>
...
<!-- description -->
	...
	<td width=99% colspan=2><p> Olympus C-460Z del Sol - цифровая фотокамера с разрешением ПЗС-матрицы 4.23 млн. пикселей. Максимальное разрешение фотокадров 2288 x 1712, тип карты памятиxD-Picture Card (В комплекте карта памяти на 16 Мб)</td>
<td width=1% valign=top align=right></td></tr></table>
